...
public:
	...
	virtual void ann_search(ANNdist, ANNpoint &, double &, ANNmin_k*, ANNpointArray &, int&) = 0;		
												// AKU tree search
...
public:
	...
	virtual void ann_search(ANNdist, ANNpoint &, double &, ANNmin_k*, ANNpointArray &, int &);
												// AKU standard search
